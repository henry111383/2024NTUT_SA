...
import tw.teddysoft.tasks.io.springboot.ToDoListSpringBootApp;

@ComponentScan(basePackages={"tw.teddysoft.tasks"}, excludeFilters= {
        @ComponentScan.Filter(type= FilterType.ASSIGNABLE_TYPE, value= ToDoListSpringBootApp.class),
        @ComponentScan.Filter(type= FilterType.ASSIGNABLE_TYPE, value= SpringBootApplicationTest.class)})
